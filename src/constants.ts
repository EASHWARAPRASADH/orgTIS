...
export const INITIAL_EMPLOYEES: Employee[] = [
  ...
  },
  {
    ...
    role: "Lead",
    department: "IST DYNAMICS",
    photoUrl: "/photos/maheshwaran.png",
    managerId: "sriram",
    color: "#93C5FD",
    displayOrder: 21,
  },
  ...
  },
  {
    ...
    role: "Lead",
    department: "IST NEXUS",
    photoUrl: "https://picsum.photos/seed/dhipak/100/100",
    managerId: "yusuf",
    color: "#C084FC",
    displayOrder: 31,
  },
  ...["Arpit", "Nithish", "Manikandan", "Shivani", "Purushoth", "Nithish_2", "Swedha Sri", "Monikka"].map((name, i) => ({
    ...
    role: "Team Member",
    department: "IST NEXUS",
    photoUrl: name === "Purushoth" ? "/photos/purushoth.png" : `https://picsum.photos/seed/${name}/100/100`,
    managerId: "dhipak",
    color: "#C084FC",
    displayOrder: 32 + i,
  })),
  ...
  ...["Madhesh", "Anjali", "Nitesh", "Harini", "Daksh", "Prasana Vengates", "Vishveshwar", "Jayasuriya"].map((name, i) => ({
    ...
    photoUrl: name === "Prasana Vengates" ? "/photos/prasanna venkatesh.png" : `https://picsum.photos/seed/${name}/100/100`,
    managerId: "priyadharshini",
    color: "#E5E7EB",
    displayOrder: 50 + i,
  })),
